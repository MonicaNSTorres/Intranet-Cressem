...
const DEBUG_SIMULAR_ANA_FUNCIONARIO = false;
const DEBUG_NOME_ANA_FUNCIONARIO = "ANA CAROLINA MOTA HESPANHA RODRIGUES";
const DEBUG_ACESSO_ATIVO =
    DEBUG_SIMULAR_ANA_FUNCIONARIO ||
...
const DEBUG_FORCAR_GESTOR_NOME = String(
    ...
    (DEBUG_SIMULAR_ANA_FUNCIONARIO ? DEBUG_NOME_ANA_FUNCIONARIO : "")
).trim();
