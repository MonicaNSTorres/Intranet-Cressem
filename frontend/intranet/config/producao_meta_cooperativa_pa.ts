...
export const MAPA_TEMA_PARA_TABELA: Record<string, string> = {
  ...
  conta_corrente_abertas: "CONTA_CORRENTE_DIARIO_NOVO_NORMALIZADO",
  entrada_cooperados: "CONTA_CAPITAL_DIARIO_NOVO_NORMALIZADO",
  saldo_cooperados: "CONTA_CAPITAL_DIARIO_NOVO",
  conta_poupanca: "CONTA_CAPITAL_DIARIO_NOVO",
  emprestimo_bancoob: "CARTAO_CREDITO_BANCOOB_DIARIO_NORMALIZADO",
