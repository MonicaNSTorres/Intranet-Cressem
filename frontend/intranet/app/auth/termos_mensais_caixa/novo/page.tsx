...
export default function NovoTermoMensalCaixaPage() {
        ...
        <div className="mt-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">
              Nova Conferência de Caixa
            </h1>
            <p className="mt-1 text-sm text-gray-600">
              Preencha os dados do termo mensal, salve o rascunho e gere o PDF.
            </p>
          </div>
        </div>
      </div>

      <TermoMensalCaixaForm />
