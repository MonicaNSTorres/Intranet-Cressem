      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            ...
            className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-2xl bg-primary px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-secondary"
          >
            <FaGavel />
            Gerenciar leilões
          </button>
          ...
          <button
            ...
            className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-2xl border border-yellow-200 bg-linear-to-r from-yellow-50 to-amber-50 px-5 py-3 text-sm font-bold text-yellow-700 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-yellow-100"
          >
            <FaTrophy />
            Leilões encerrados
          </button>
