...
export type PdfSubsidioAuditivoOpts = {
  ...
  nivelIntegralizacao?: string;
  capital?: string;
  dataEntregaNotaFiscal?: string;
...
export async function gerarPdfSubsidioAuditivo(o: PdfSubsidioAuditivoOpts) {
  const doc = new jsPDF({
    unit: "pt",
    format: "a4",
    compress: true,
  ...
  doc.text("Autorização para Pagamento de subsídio auditivo", pageW / 2, y, {
    align: "center",
  });
  doc.setTextColor(0, 0, 0);
  y += 26;
  ...
  drawSectionHeader(doc, "Associado solicitante", margin, y, contentW);
  y += 18;
  ...
  y = drawFieldsRow(doc, y, margin, contentW, [
    { label: "Local de trabalho", value: safeText(o.localTrabalho), width: contentW * 0.62 },
    { label: "Cargo", value: safeText(o.cargoAssociado), width: contentW * 0.38 },
  ]);
  y = drawFieldsRow(doc, y, margin, contentW, [
    { label: "Celular", value: safeText(o.celular), width: contentW * 0.32 },
    { label: "Telefone residencial", value: safeText(o.telefoneResidencial), width: contentW * 0.33 },
  ...
  drawSectionHeader(doc, "Informações para análise", margin, y, contentW);
  y += 18;
  y = drawFieldsRow(doc, y, margin, contentW, [
    { label: "Data de associação", value: toBrFromIso(o.dataAssociacao || ""), width: contentW * 0.22 },
    { label: "Nível de integralização", value: safeText(o.nivelIntegralizacao), width: contentW * 0.28 },
    { label: "Capital", value: safeText(o.capital), width: contentW * 0.5 },
  ]);
  ...
  y += 18;
  y = drawFieldsRow(doc, y, margin, contentW, [
    { label: "Valor solicitado", value: o.valorSolicitado, width: contentW * 0.23 },
    { label: "Valor liberado", value: o.valorAprovado, width: contentW * 0.23 },
    { label: "CPF/CNPJ do prestador", value: safeText(o.cpfCnpjPrestador), width: contentW * 0.26 },
    { label: "Data de entrega da nota", value: toBrFromIso(o.dataEntregaNotaFiscal || ""), width: contentW * 0.28 },
  ]);
  y = drawFieldsRow(doc, y, margin, contentW, [
    { label: "Prestador de serviço", value: o.prestadorServico, width: contentW },
  ]);
  ...
  y += 18;
  y = drawFieldsRow(doc, y, margin, contentW, [
    { label: "Banco", value: safeText(o.banco), width: contentW * 0.33 },
    { label: "Agência", value: safeText(o.agencia), width: contentW * 0.16 },
    { label: "Conta", value: safeText(o.conta), width: contentW * 0.26 },
  ...
  y = writeParagraphBoldParts(
    doc,
    [
      { text: "Declaro que as informacoes apresentadas nesta solicitacao sao verdadeiras e autorizo o encaminhamento interno do pedido de subsidio para protese ou aparelho auditivo do associado " },
  ...
  const sigTopY = y + 28;
  drawSignature(doc, margin, sigTopY, sigTopW, o.nomeAssociado, "Associado solicitante");
  drawSignature(
    doc,
  ...
  doc.save(`autorizacao_subsidio_auditivo_${sanitize(o.nomeAssociado)}.pdf`);
}
