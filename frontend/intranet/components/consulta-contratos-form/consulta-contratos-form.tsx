            ...
            <div className="md:col-span-12">
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-secondary px-5 text-sm font-semibold text-white shadow-sm transitionhover:bg-primary cursor-pointer disabled:cursor-not-allowed disabled:opacity-60"
                >
                  <FaSearch />
                  ...
                  <tbody className="bg-white text-sm text-slate-700">
                    {items.map((item) => (
                      ...
                      >
                        ...
                        <td className="border-b border-slate-100 px-4 py-3">
                          <span
                            className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${Number(item.SN_ATIVO || 0) === 1
