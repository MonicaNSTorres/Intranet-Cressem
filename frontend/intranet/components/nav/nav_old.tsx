    ...
    >
      ...
      >
        <ul className="space-y-2 p-4">
          ...
          {/*Gerenciador de Contratos (enabled manteve escondido) className="hidden"*/}
          <li>
            <button
              type="button"
            ...
            {isOpen && isGerContratosOpen && (
              <ul className="mt-1 ml-10 space-y-1">
                <li>
                  <Link href="/auth/cadastro_contrato" legacyBehavior>
                    <a
                      onClick={closeSidebar}
                      className={`flex items-center space-x-2 hover:text-white transition-colors duration-200 py-2 px-3 rounded-md ${isActive(
          ...
          <li>
            ...
            {isOpen && isGerConveniosOpen && (
              <ul className="mt-1 ml-10 space-y-1">
                {/*Cadastro (enabled manteve escondido)  className="hidden"*/}
                <li>
          ...
          {/*Recibos Financeiros (enabled manteve escondido) className="hidden"*/}
          <li>
            <button
              type="button"
