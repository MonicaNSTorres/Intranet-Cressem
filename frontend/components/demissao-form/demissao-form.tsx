    ...
    try {
      ...
      if (!idDemissaoGravada) {
        ...
        erroNotificacaoConvenioAtivo = String(
          registro.erroNotificacaoConvenioAtivo || ""
        );
      }
      ...
      if (
        ...
        try {
          const resultado = await desativarConvenioDemissao(
          ...
          erroEmailConvenio = String(resultado?.erroEmail || "");
      ...
      if (deveInativarConvenio) {
        setInfo(
          emailConvenioEnviado
            ...
            : `PDF gerado e benefício odontológico inativado. Atenção: a notificação por e-mail não foi enviada${erroEmailConvenio ? ` (${erroEmailConvenio})` : ""}.`
        );
      ...
      if (convenioOdontologico?.situacao === "ATIVO") {
        setInfo(
          notificacaoConvenioAtivoEnviada
            ...
            : `PDF gerado. O benefício odontológico permaneceu ativo. Atenção: o e-mail de alerta não foi enviado${erroNotificacaoConvenioAtivo ? ` (${erroNotificacaoConvenioAtivo})` : ""}.`
        );
        return;
      }
