          ...
          <div className="p-5 sm:p-6">
            <div className="mb-5 flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="rounded-xl border border-primary/20 bg-primary/10 px-4 py-3">
                ...
                <p className="mt-0.5 text-base font-bold text-(--title)">
                  R$ 12,70
                </p>
              </div>
            </div>
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-200">
              <table className="min-w-full border-collapse text-sm text-slate-700">
                <thead>
                  <tr className="border-b border-primary/20 bg-primary/10 text-xs font-bold uppercase tracking-wide text-primary">
