...
export const SCREENS: ScreenItem[] = [
  ...
  {
    title: "Folha Odontológica",
    desc: "Gerar e enviar os arquivos mensais de desconto em folha.",
    href: "/auth/automacao_convenio_odontologico",
    group: "Beneficios",
    allowedGroups: [AD_GROUPS.SUPORTE, AD_GROUPS.CONVENIO_ODONTO],
    keywords: ["convenio", "convênio", "odonto", "folha", "desconto"],
  },
  {
    title: "Cargos",
  ...
  },
  {
    ...
    desc: "Consultar contatos cadastrados na lista de Não Perturbe do Blip.",
  ...
  {
    title: "Relatório Convênio Odontológico",
    desc: "Emissão de relátorios.",
